        ...
        <div className="profile-card panel">
          ...
          <div className="profile-details">
            ...
            <div className="profile-detail">
              ...
              <div><span className="detail-label">Products Ordered</span><span className="detail-value">{ownedGames.length}</span></div>
            </div>
          </div>
        </div>
              ...
              <div className="profile-games">
                {ownedGames.slice(0, 4).map(g => (
                  <div key={g.id} className="profile-game-row">
                    <div className="profile-game-dot" style={{ background: 'var(--accent)' }} />
            ...
            <div className="panel">
              ...
              {orders.map(o => (
                <div key={o.id} className="order-row">
                  <div>
                    <div className="order-name">{o.games?.map(g => g.title).join(', ') || 'Product purchase'}</div>
